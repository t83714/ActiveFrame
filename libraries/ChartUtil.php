...
class ChartUtil
{
	...
	{
		$chartInfo=self::loadXmlChart($chartSWF, $strURL, $chartId, $cWidth, $cHeight, $debugMode, $registerWithJS);
	...
	function render_by_xml($type,$xml,$w,$h,$debug=0,$registerWithJS=0)
	{
